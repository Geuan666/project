...
def main() -> None:
    ...
    repr_rows: List[Dict[str, object]] = list(read_csv_rows(repr_path))
    align_rows: List[Dict[str, object]] = list(read_csv_rows(align_path))
    patch_rows: List[Dict[str, object]] = list(read_csv_rows(patch_path))
    top_rows: List[Dict[str, object]] = list(read_csv_rows(top_path))
    processed_ids = {str(r["sample_id"]) for r in patch_rows}
