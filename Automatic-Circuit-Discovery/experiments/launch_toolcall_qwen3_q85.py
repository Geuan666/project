...
def run_one_sample(
    *,
    ...
    ct_ap_top_per_layer = max(0, int(os.environ.get("ACDC_CT_AP_PER_LAYER", "0")))
    ct_ap_top_global = max(0, int(os.environ.get("ACDC_CT_AP_TOP_GLOBAL", "0")))
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", type=str, default="experiments/results/toolcall_single")
    ...
    if out_dir.name == "toolcall_single":
