...
python experiments/evaluate_toolcall_consistency.py \
  --base-root experiments/results/toolcall_project_1189 \
  --variant refined=experiments/results/toolcall_project_1189_refined_consistent \
...
def main() -> None:
    ...
    parser.add_argument("--base-root", type=str, default="experiments/results/toolcall_project_1189")
    parser.add_argument(
        "--variant",
        action="append",
        default=[],
