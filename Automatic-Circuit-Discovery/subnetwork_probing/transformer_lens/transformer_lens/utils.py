...
# `TRANSFORMERS_CACHE` was removed from newer transformers releases.
# Keep backward compatibility with both old and new versions.
CACHE_DIR = (
    getattr(transformers, "TRANSFORMERS_CACHE", None)
