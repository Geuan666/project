...
def get_model(device):
    try:
        ...
        # transformers>=5 can fail to parse the redwood tokenizer json.
        # Fallback to GPT-2 tokenizer keeps this model loadable across versions.
        if "Token" not in str(e) and "tokenizer" not in str(e).lower():
            raise
