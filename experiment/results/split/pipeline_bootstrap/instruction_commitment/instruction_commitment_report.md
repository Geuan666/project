...
- Query chain on `clean_with_corrupt_instruction`: `L20H5|L21H1|L21H12|L24H6|MLP27` -> rescue `0.991`, tool-top1 `0.939`.
- No-tool chain on `corrupt_with_clean_instruction`: `L16H4|MLP17|L23H6` -> rescue `0.792`, no-tool-top1 `0.517`.
